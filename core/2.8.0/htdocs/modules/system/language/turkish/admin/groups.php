 ...
 * _CHARSET     UTF-8
 */
define('_AM_SYSTEM_GROUPS_NAV_MANAGER', 'Gruplar Yöneticisi');
define('_AM_SYSTEM_GROUPS_NAV_LIST', 'Gruplar listesi');
...
define('_AM_SYSTEM_GROUPS_NAV_TIPS_1', '<ul><li>Kendi izinleriyle yeni bir grup oluşturun.</li><li>Değişiklik izinleri için grubu düzenleyin.</li></ul>');
...
define('_AM_SYSTEM_GROUPS_ACTION', 'İşlem');
...
define('_AM_SYSTEM_GROUPS_NAME', 'Grup Adı');
define('_AM_SYSTEM_GROUPS_NB_USERS_BY_GROUPS', 'Kullanıcıları gruba göre numaralandırın');
...
define('_AM_SYSTEM_GROUPS_NB_USERS_BY_GROUPS_USERS', '%s kullanıcı');
